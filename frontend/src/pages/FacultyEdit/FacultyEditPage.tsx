...
import { InchargeManagementSection } from "./InchargeManagementSection";
import { AssignInchargeDialog } from "./AssignInchargeDialog";
...
export function EditFacultyPage() {
  ...
  const initial: FacultyInput = {
    ...
    higherEducation: record.higherEducation || record.higher_education || "",
