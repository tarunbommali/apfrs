    ...
    <TooltipProvider delayDuration={150}>
      ...
      >
        ...
        <div className="flex h-14 items-center justify-between px-3.5 border-b border-sidebar-border/80">
          {collapsed ? (
            /* Collapsed: JNTU-GV Logo by default, on Hover smoothly reveals Open Sidebar Toggle Button */
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="group relative flex size-10 items-center justify-center rounded-lg transition-colors hover:bg-sidebar-accent"
                  >
                    {/* Default Official JNTU-GV Logo */}
                    <div className="flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-white/90 p-0.5 shadow-sm transition-all duration-200 group-hover:scale-0 group-hover:opacity-0">
                      <img
                        src={logoImg}
                        alt="JNTU-GV Logo"
            ...
            <>
              <div className="flex items-center gap-2.5 overflow-hidden">
                <div className="flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-white/90 p-0.5 shadow-sm">
                  <img
                    src={logoImg}
                    alt="JNTU-GV Logo"
                    className="size-full object-contain"
                ...
                <div className="flex flex-col truncate">
                  ...
                  <span className="text-[10px] text-sidebar-foreground/70 leading-tight truncate">Attendance System</span>
                </div>
              </div>
