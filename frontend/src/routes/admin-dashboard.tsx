...
// Subcomponents
import { RegistrySkeleton } from "./-admin-dashboard/RegistrySkeleton";
import { SummaryCards } from "./-admin-dashboard/SummaryCards";
import { SearchFilters } from "./-admin-dashboard/SearchFilters";
import { FacultyRow } from "./-admin-dashboard/FacultyRow";
import { Pagination } from "./-admin-dashboard/Pagination";
import { ErrorState } from "./-admin-dashboard/ErrorState";
