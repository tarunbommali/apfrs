 ...
 */
export const calculateWorkingDaysFromCalendar = (monthNumber, totalDaysInMonth = 31, year = new Date().getFullYear()) => {
 ...
 * 
 * This function is the complement to calculateWorkingDaysFromCalendar and uses the SAME
